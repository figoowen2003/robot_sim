...
class Controller(Node):
  ...
  def __init__(self):
    ...
    self.turning_speed_wf_slow = 0.025 # Slow turn
    ...
    self.dist_too_close_to_wall = 0.1 # in meters
  ...
  def follow_wall(self):
    ...
    #self._logger.info("self.rightfront_dist:{}".format(self.rightfront_dist))
    #self._logger.info("self.leftfront_dist:{}".format(self.leftfront_dist))
    #self._logger.info("self.left_dist:{}".format(self.left_dist))
    #self._logger.info("self.right_dist:{}".format(self.right_dist))
    #self._logger.info("self.front_dist:{}".format(self.front_dist))

    # have no wall, just go straight until the wall appear in front_dist
    if self.leftfront_dist > d and self.front_dist > d and self.rightfront_dist > d:
      self.wall_following_state = "search for wall"
      #self._logger.info("here is the first branch")
      msg.linear.x = self.forward_speed

    # The case for the wall appears in front_dist
    elif self.leftfront_dist > d and self.front_dist < d and self.rightfront_dist > d:
      msg.angular.z = self.turning_speed_wf_slow

      #self._logger.info("here is the second branch")

    # The wall appears in the rightfront_dist
    elif (self.leftfront_dist > d and self.front_dist > d and self.rightfront_dist < d):
      msg.angular.z = self.turning_speed_wf_fast
      # msg.linear.x = self.forward_speed
      #self._logger.info("here is the third branch")

    # The wall appears in the leftfront_dist
    elif self.leftfront_dist < d and self.front_dist > d and self.rightfront_dist > d:

      msg.angular.z = -self.turning_speed_wf_fast # turn right to find wall
      #self._logger.info("here is the fourth branch")

    elif self.leftfront_dist > d and self.front_dist < d and self.rightfront_dist < d:
      self.wall_following_state = "turn left"
      #self._logger.info("here is the fifth branch")
      msg.angular.z = self.turning_speed_wf_fast

    elif self.leftfront_dist < d and self.front_dist < d and self.rightfront_dist > d:
      self.wall_following_state = "turn right"
      #self._logger.info("here is the sixth branch")
      msg.angular.z = -self.turning_speed_wf_fast
      ...
      msg.angular.z = self.turning_speed_wf_fast
      #self._logger.info("here is the tenth branch")
    else:
      pass
